...
import { Area, AreaChart, ResponsiveContainer, Legend, Tooltip, XAxis, YAxis, Line, Bar, CartesianGrid, LineChart, BarChart } from 'recharts';
...
const Row1 = () => {
  ...
  return (
    ...
    <BoxHeader title="Revenue Month by Month" 
      subtitle="graph represting revenue month by month" 
      sideText="+4%" />
    <ResponsiveContainer width="100%" height="100%">
        <BarChart
          width={500}
