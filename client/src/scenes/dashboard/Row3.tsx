...
const Row3 = () => {
  ...
  const pieChartData = useMemo(() => {
    if(kpiData) {
      const totalExpesnes = kpiData[0].totalExpenses;
  ...
  return (
    ...
    <DashboardBox  gridArea="g">
      <BoxHeader 
          ...
          sideText={`${productData?.length} products`} subtitle={''}      />
      <Box
      mt="0.5rem"
      p="0 0.5rem"
      height="75%"
    ...
    <BoxHeader 
          title="Recent Orders"
          sideText={`${transactionData?.length} latest transactions`} subtitle={''}      />
      <Box
      mt="1rem"
      p="0 0.5rem"
      height="80%"
